        ...
        switch (_b.label) {
            ...
            case 4:
                ...
                if (existCustomer !== null) {
                    return [2 /*return*/, res.status(409).json({ message: "An user exists with this email" })];
                }
            ...
            case 7:
                ...
                return [2 /*return*/, res.status(201).json({ signature: signature, veified: result.verified, email: result.email })];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!(parseInt(profile.otp) === parseInt(otp) && profile.otp_expiry >= new Date())) return [3 /*break*/, 3];
            ...
            case 3: return [2 /*return*/, res.status(400).json({ message: "Error with otp validation" })];
        }
    });
}); };
...
var RequestOtp = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                _b.sent();
                return [2 /*return*/, res.status(200).json({ message: "OTP sent to your registered phone number" })];
            case 4: return [2 /*return*/, res.status(400).json({ message: "Error with otp validation" })];
        }
    });
}); };
