...
var GetFoodsIn30mins = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var pincode, result, foodResult_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pincode = req.params.pincode;
                return [4 /*yield*/, models_1.Vandor.find({ pincode: pincode, serviceAvailable: false }).populate("foods")];
            case 1:
                result = _a.sent();
                if (result.length > 0) {
                    foodResult_1 = [];
